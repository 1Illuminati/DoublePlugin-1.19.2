...
public class WorldHelper {
	private static final ArrayList<String> ignoreList = new ArrayList<>(Arrays.asList("uid.dat", "session.lock"));
	...
	public void copyWorld(String newWorldName) {
		new FileHelper(world.getWorldFolder()).copyFile(new File(Bukkit.getWorldContainer(), newWorldName), ignoreList);
